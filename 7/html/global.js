...
switch(pg_id){
	...
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide1.css" media="screen"/><div class="background"><img src="slide2/1.jpg" width="1024" height="768" alt=""></div><div class="kol" onclick="kol();"><img src="slide2/2.png"></div><video id="myVideo" width="1024" height="768" src="slide2/3.mp4" controls></video><div class="closekol" onclick="closekol();"><img src="slide2/4.png"></div>';
	break;
	case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide2.css" media="screen"/><div class="background"><img src="slide3/1.jpg" width="1024" height="768" alt=""></div>';
	break;
	case 4:
