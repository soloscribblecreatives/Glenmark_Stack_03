...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="background"><img src="slide1/1.jpg" width="1024" height="768" alt=""></div><div class="s2"><img src="slide1/2.png"></div><div class="s3_wrap"><div class="s3"><img src="slide1/3.png"></div><div class="s4"><img src="slide1/4.png"></div><div class="s5"><img src="slide1/5.png"></div><div class="s6"><img src="slide1/6.png"></div><div class="pop_up"><img src="slide1/3.jpg" width="1024" height="768" alt=""></div><div class="pop1" onclick="pop1()"></div><div class="c1ose1" onclick="close1()"></div><div class="pop_up2"><img src="slide1/2.jpg" width="1024" height="768" alt=""></div><div class="pop2" onclick="pop2()"></div><div class="c1ose2" onclick="close2()"></div>';
	break;
