...
switch(pg_id){
	...
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/1.jpg" width="1024" height="768" alt=""></div><div class="s2"><img src="slide2/2.png"></div><div class="s3"><img src="slide2/3.png"></div><div class="s4"><img src="slide2/4.png"></div>';
	break;
    case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="background"><img src="slide3/1.jpg" width="1024" height="768" alt=""></div><div class="s2"><img src="slide3/2.png"></div><div class="s3"><img src="slide3/3.png"></div><div class="s4"><img src="slide3/4.png"></div><div class="pop_up"><img src="slide3/2.jpg" width="1024" height="768" alt=""></div><div class="pop1" onclick="pop1()"></div><div class="c1ose1" onclick="close1()"></div>';
	break;
}
